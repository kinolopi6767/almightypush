...
- **M7** Audit log (panel actions → settings viewer)
...
pnpm --filter @pushpanel/web exec playwright test   # full e2e suite (37 tests)
```
...
`M7` — final hardening (in progress). See BUILD-PLAN.md §20 for the milestone timeline.