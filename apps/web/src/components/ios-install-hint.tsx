...
export function IosInstallHint() {
 ...
 return (
  <div className="panel enter fixed bottom-[calc(1rem+env(safe-area-inset-bottom))] right-4 z-50 max-w-xs p-4">
   <p className="text-[13.5px] font-semibold tracking-tight">Install PushPanel</p>
   <ol className="hint mt-2 list-decimal space-y-1 pl-5">
