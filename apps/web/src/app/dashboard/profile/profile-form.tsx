...
export function ProfileForm({ name }: { name: string }) {
  ...
  return (
    <form action={action} className="max-w-md space-y-4 surface rounded-xl p-5">
      ...
      {state?.ok && <p className="rounded-lg bg-emerald-500/10 px-3 py-2 text-sm text-emerald-600 dark:text-emerald-400">Profile updated.</p>}
