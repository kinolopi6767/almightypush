...
import { DeleteDomainForm, CloneDomainForm, DomainStatusForm } from "../domain-manage-forms";
 ...
 return (
  <>
   <div className="enter">
    ...
    <PageHeader eyebrow="Operate · Domains"
     title={
   ...
   <div className="mt-8 grid gap-4 sm:grid-cols-3">
    <div className="enter">
     <StatCard label="Active subscribers" value={activeSubs.toLocaleString()} tone="brand" />
    </div>
    <div className="enter enter-1">
     <StatCard label="Clicks" value={(clicksRow?.value ?? 0).toLocaleString()} tone="warn" />
    </div>
   ...
   {funnelRows.length > 0 && (
    <div className="panel enter enter-1 mt-4 rounded-md p-5">
     <p className="micro-label">Opt-in funnel · 30 days</p>
   ...
   <div className="mt-8 grid gap-6 lg:grid-cols-2">
    <div className="space-y-6">
     ...
     <section className="panel p-4">
      ...
      <code className="mt-3 block break-all rounded-md border bg-muted/40 p-3 text-xs leading-relaxed">
    ...
    <TestPushForm domainId={domain.id} />
     <div className="mt-6 space-y-6">
      ...
      <CloneDomainForm domainId={domain.id} name={domain.name} />
