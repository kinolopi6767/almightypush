    ...
    <form action={formAction} className="h-fit rounded-xl border bg-card p-5 shadow-[var(--shadow-card)]">
      ...
      <div className="mt-4 space-y-3">
        ...
        <button
          type="submit"
          disabled={pending}
          className="inline-flex h-9 w-full items-center justify-center gap-2 rounded-md bg-primary px-4 text-sm font-medium text-primary-foreground shadow transition-all hover:bg-primary/90 active:scale-[0.98] disabled:pointer-events-none disabled:opacity-60"
        >
          {pending && (
            <span
              aria-hidden
