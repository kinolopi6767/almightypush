 ...
 return (
  <div className="space-y-6">
   ...
   <div className="grid gap-3 md:grid-cols-2">
    ...
    <div className="panel rounded-md p-5 ring-1 ring-primary/15">
   ...
   <div className="panel p-4">
    ...
    {gens.length === 0 ? (
     <p className="mt-3 rounded-md border border-dashed p-4 text-center text-sm text-muted-foreground">No generations yet — try Hook Angles from your app or AI Studio API.</p>
    ) : (
