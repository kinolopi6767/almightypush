 ...
 return (
  <span className="inline-flex items-center gap-2">
   <button
    ...
    className="inline-flex h-7 items-center rounded-md border border-input bg-card px-2.5 text-xs font-medium hover:bg-accent disabled:opacity-50"
   >
...
export function SettingsForm({
 ...
 return (
  <form action={action} className="space-y-4 panel p-4">
  ...
  <form action={action} className="space-y-4 panel p-4">
   ...
   <div className="grid gap-4 sm:grid-cols-2">
    ...
    <div className="space-y-1">
     ...
     <select id="mail_provider" name="mail_provider" defaultValue={mailProvider} className="input">
