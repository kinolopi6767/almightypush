    ...
    <form action={formAction} className="rounded-xl border bg-card p-5">
      ...
      <div className="mt-3 flex flex-wrap gap-2">
        <button
          ...
          value="duplicate"
          disabled={pending}
          className="inline-flex h-9 flex-1 items-center justify-center rounded-md bg-primary px-4 text-sm font-medium text-primary-foreground shadow transition-colors hover:bg-primary/90 disabled:pointer-events-none disabled:opacity-50"
        >
